...
export const allCars: Car[] = [
  ...
  },
  {
    ...
    info: "1 автомобиль",
    images: [
      PlaceHolderImages.find((img) => img.id === "tenet-t7-silver-1")!,
      PlaceHolderImages.find((img) => img.id === "tenet-t7-silver-2")!,
      PlaceHolderImages.find((img) => img.id === "tenet-t7-silver-3")!,
      PlaceHolderImages.find((img) => img.id === "tenet-t7-silver-4")!,
      PlaceHolderImages.find((img) => img.id === "tenet-t7-silver-5")!,
    ],
    gearbox: "робот",
    bodyType: "внедорожник",
    count: 1,
