...
export const metadata: Metadata = {
  ...
  description:
    "Купите новые автомобили TENET T4, T7, T8 у официального дилера TENET Сервис Кубань в Краснодаре. Выгодные цены, лучшие комплектации и специальные предложения.",
  keywords: [
